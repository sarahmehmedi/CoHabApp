...
class BillsFormViewController: FormViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Submit", style: .Plain, target: self, action: #selector(BillsFormViewController.submit(_:)))
    }
